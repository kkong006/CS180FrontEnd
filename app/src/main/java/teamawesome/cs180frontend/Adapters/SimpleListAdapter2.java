...
public class SimpleListAdapter2 extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.nameTextView.setText(profClassBundleList.get(position).getClassName());
        holder.countTextView.setText(String.valueOf(profClassBundleList.get(position).getReviewCnt()));
